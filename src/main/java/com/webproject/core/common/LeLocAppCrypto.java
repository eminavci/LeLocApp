...
public class LeLocAppCrypto {
    ...
    public static String sign(String message) {
        return sign(message, LELOCAPP.secretKey.getBytes());
    }
    ...
    public static String encryptAES(String value) {
        return encryptAES(value, LELOCAPP.secretKey.substring(0, 16));
    }
    ...
    public static String decryptAES(String value) {
        return decryptAES(value, LELOCAPP.secretKey.substring(0, 16));
    }
